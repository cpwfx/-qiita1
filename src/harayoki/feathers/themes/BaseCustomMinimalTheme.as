package harayoki.feathers.themes
{
	...
	public class BaseCustomMinimalTheme extends StyleNameFunctionTheme
	{
		 ...
		 */
		public function BaseCustomMinimalTheme(fontName:String="_sans")
		{
		...
		override public function dispose():void
		{
			...
			TextField.unregisterBitmapFont(fontName);
		...
		protected function initializeFonts():void
		{
			...
			this.primaryTextFormat = new BitmapFontTextFormat(fontName, this.fontSize, PRIMARY_TEXT_COLOR);
			this.disabledTextFormat = new BitmapFontTextFormat(fontName, this.fontSize, DISABLED_TEXT_COLOR);
			this.centeredTextFormat = new BitmapFontTextFormat(fontName, this.fontSize, PRIMARY_TEXT_COLOR, TextFormatAlign.CENTER);
			this.centeredDisabledTextFormat = new BitmapFontTextFormat(fontName, this.fontSize, DISABLED_TEXT_COLOR, TextFormatAlign.CENTER);
			this.headingTextFormat = new BitmapFontTextFormat(fontName, this.largeFontSize, PRIMARY_TEXT_COLOR);
			this.headingDisabledTextFormat = new BitmapFontTextFormat(fontName, this.largeFontSize, DISABLED_TEXT_COLOR);
			this.detailTextFormat = new BitmapFontTextFormat(fontName, this.smallFontSize, PRIMARY_TEXT_COLOR);
			this.detailDisabledTextFormat = new BitmapFontTextFormat(fontName, this.smallFontSize, DISABLED_TEXT_COLOR);
			this.dangerTextFormat = new BitmapFontTextFormat(fontName, this.fontSize, DANGER_TEXT_COLOR);
