package harayoki.feathers.themes
{
	...
	public class BaseCustomMetalWorksMobileTheme extends StyleNameFunctionTheme
	{
		...
		{
			var quad:Quad = new MyQuad(100, 100, MODAL_OVERLAY_COLOR);
		 ...
		 * Constructor.
		 */
		public function BaseCustomMetalWorksMobileTheme(fontName:String="_sans")
		{
		...
		public static var dummyTexture:Texture;

		//protected var quadTexture:Texture;
		...
		protected function initializeFonts():void
		{
			...
			this.scrollTextTextFormat = new TextFormat(fontName, this.regularFontSize, LIGHT_TEXT_COLOR);
			this.scrollTextDisabledTextFormat = new TextFormat(fontName, this.regularFontSize, DISABLED_TEXT_COLOR);

			this.regularFontDescription = new FontDescription(fontName, FontWeight.NORMAL, FontPosture.NORMAL, FontLookup.EMBEDDED_CFF, RenderingMode.CFF, CFFHinting.NONE);
			this.boldFontDescription = new FontDescription(fontName, FontWeight.BOLD, FontPosture.NORMAL, FontLookup.EMBEDDED_CFF, RenderingMode.CFF, CFFHinting.NONE);
		...
		private function _getTexture(name:String):Texture {
			var texture:Texture = this.atlas.getTexture(name);
			return texture || dummyTexture || Texture.fromColor(10,10,0xffffff);
		}
		...
		{
			this.backgroundSkinTexture = _getTexture("background-skin0000");
			this.backgroundDisabledSkinTexture = _getTexture("background-disabled-skin0000");
			this.backgroundInsetSkinTexture = _getTexture("background-inset-skin0000");
			this.backgroundInsetDisabledSkinTexture = _getTexture("background-inset-disabled-skin0000");
			this.backgroundInsetFocusedSkinTexture = _getTexture("background-focused-skin0000");
			this.backgroundInsetDangerSkinTexture = _getTexture("background-inset-danger-skin0000");
			this.backgroundLightBorderSkinTexture = _getTexture("background-light-border-skin0000");
			this.backgroundDarkBorderSkinTexture = _getTexture("background-dark-border-skin0000");
			this.backgroundDangerBorderSkinTexture = _getTexture("background-danger-border-skin0000");

			this.buttonUpSkinTexture = _getTexture("button-up-skin0000");
			this.buttonDownSkinTexture = _getTexture("button-down-skin0000");
			this.buttonDisabledSkinTexture = _getTexture("button-disabled-skin0000");
			this.buttonSelectedUpSkinTexture = _getTexture("toggle-button-selected-up-skin0000");
			this.buttonSelectedDisabledSkinTexture = _getTexture("toggle-button-selected-disabled-skin0000");
			this.buttonCallToActionUpSkinTexture = _getTexture("call-to-action-button-up-skin0000");
			this.buttonCallToActionDownSkinTexture = _getTexture("call-to-action-button-down-skin0000");
			this.buttonDangerUpSkinTexture = _getTexture("danger-button-up-skin0000");
			this.buttonDangerDownSkinTexture = _getTexture("danger-button-down-skin0000");
			this.buttonBackUpSkinTexture = _getTexture("back-button-up-skin0000");
			this.buttonBackDownSkinTexture = _getTexture("back-button-down-skin0000");
			this.buttonBackDisabledSkinTexture = _getTexture("back-button-disabled-skin0000");
			this.buttonForwardUpSkinTexture = _getTexture("forward-button-up-skin0000");
			this.buttonForwardDownSkinTexture = _getTexture("forward-button-down-skin0000");
			this.buttonForwardDisabledSkinTexture = _getTexture("forward-button-disabled-skin0000");

			this.tabUpSkinTexture = Texture.fromTexture(_getTexture("tab-up-skin0000"), TAB_SKIN_TEXTURE_REGION);
			this.tabDownSkinTexture = Texture.fromTexture(_getTexture("tab-down-skin0000"), TAB_SKIN_TEXTURE_REGION);
			this.tabDisabledSkinTexture = Texture.fromTexture(_getTexture("tab-disabled-skin0000"), TAB_SKIN_TEXTURE_REGION);
			this.tabSelectedUpSkinTexture = Texture.fromTexture(_getTexture("tab-selected-up-skin0000"), TAB_SKIN_TEXTURE_REGION);
			this.tabSelectedDisabledSkinTexture = Texture.fromTexture(_getTexture("tab-selected-disabled-skin0000"), TAB_SKIN_TEXTURE_REGION);

			this.pickerListButtonIconTexture = _getTexture("picker-list-button-icon0000");
			this.pickerListButtonSelectedIconTexture = _getTexture("picker-list-button-selected-icon0000");
			this.pickerListButtonIconDisabledTexture = _getTexture("picker-list-button-disabled-icon0000");
			this.pickerListItemSelectedIconTexture = _getTexture("picker-list-item-renderer-selected-icon0000");

			this.spinnerListSelectionOverlaySkinTexture = _getTexture("spinner-list-selection-overlay-skin0000");

			this.checkUpIconTexture = _getTexture("check-up-icon0000");
			this.checkDownIconTexture = _getTexture("check-down-icon0000");
			this.checkDisabledIconTexture = _getTexture("check-disabled-icon0000");
			this.checkSelectedUpIconTexture = _getTexture("check-selected-up-icon0000");
			this.checkSelectedDownIconTexture = _getTexture("check-selected-down-icon0000");
			this.checkSelectedDisabledIconTexture = _getTexture("check-selected-disabled-icon0000");
			...
			this.radioSelectedUpIconTexture = _getTexture("radio-selected-up-icon0000");
			this.radioSelectedDownIconTexture = _getTexture("radio-selected-down-icon0000");
			this.radioSelectedDisabledIconTexture = _getTexture("radio-selected-disabled-icon0000");

			this.pageIndicatorSelectedSkinTexture = _getTexture("page-indicator-selected-symbol0000");
			this.pageIndicatorNormalSkinTexture = _getTexture("page-indicator-symbol0000");

			this.searchIconTexture = _getTexture("search-icon0000");
			this.searchIconDisabledTexture = _getTexture("search-disabled-icon0000");

			this.itemRendererUpSkinTexture = _getTexture("item-renderer-up-skin0000");
			this.itemRendererSelectedSkinTexture = _getTexture("item-renderer-selected-up-skin0000");
			this.insetItemRendererUpSkinTexture = _getTexture("inset-item-renderer-up-skin0000");
			this.insetItemRendererSelectedSkinTexture = _getTexture("inset-item-renderer-selected-up-skin0000");
			this.insetItemRendererFirstUpSkinTexture = _getTexture("first-inset-item-renderer-up-skin0000");
			this.insetItemRendererFirstSelectedSkinTexture = _getTexture("first-inset-item-renderer-selected-up-skin0000");
			this.insetItemRendererLastUpSkinTexture = _getTexture("last-inset-item-renderer-up-skin0000");
			this.insetItemRendererLastSelectedSkinTexture = _getTexture("last-inset-item-renderer-selected-up-skin0000");
			this.insetItemRendererSingleUpSkinTexture = _getTexture("single-inset-item-renderer-up-skin0000");
			this.insetItemRendererSingleSelectedSkinTexture = _getTexture("single-inset-item-renderer-selected-up-skin0000");

			var headerBackgroundSkinTexture:Texture = _getTexture("header-background-skin0000");
			var popUpHeaderBackgroundSkinTexture:Texture = _getTexture("header-popup-background-skin0000");
			...
			this.calloutTopArrowSkinTexture = _getTexture("callout-arrow-top-skin0000");
			this.calloutRightArrowSkinTexture = _getTexture("callout-arrow-right-skin0000");
			this.calloutBottomArrowSkinTexture = _getTexture("callout-arrow-bottom-skin0000");
			this.calloutLeftArrowSkinTexture = _getTexture("callout-arrow-left-skin0000");
			this.dangerCalloutTopArrowSkinTexture = _getTexture("danger-callout-arrow-top-skin0000");
			this.dangerCalloutRightArrowSkinTexture = _getTexture("danger-callout-arrow-right-skin0000");
			this.dangerCalloutBottomArrowSkinTexture = _getTexture("danger-callout-arrow-bottom-skin0000");
			this.dangerCalloutLeftArrowSkinTexture = _getTexture("danger-callout-arrow-left-skin0000");

			this.horizontalScrollBarThumbSkinTexture = _getTexture("horizontal-simple-scroll-bar-thumb-skin0000");
			this.verticalScrollBarThumbSkinTexture = _getTexture("vertical-simple-scroll-bar-thumb-skin0000");

			this.listDrillDownAccessoryTexture = _getTexture("item-renderer-drill-down-accessory-icon0000");
			this.listDrillDownAccessorySelectedTexture = _getTexture("item-renderer-drill-down-accessory-selected-icon0000");
			
			this.playPauseButtonPlayUpIconTexture = _getTexture("play-pause-toggle-button-play-up-icon0000");
			this.playPauseButtonPlayDownIconTexture = _getTexture("play-pause-toggle-button-play-down-icon0000");
			this.playPauseButtonPauseUpIconTexture = _getTexture("play-pause-toggle-button-pause-up-icon0000");
			this.playPauseButtonPauseDownIconTexture = _getTexture("play-pause-toggle-button-pause-down-icon0000");
			this.overlayPlayPauseButtonPlayUpIconTexture = _getTexture("overlay-play-pause-toggle-button-play-up-icon0000");
			this.overlayPlayPauseButtonPlayDownIconTexture = _getTexture("overlay-play-pause-toggle-button-play-down-icon0000");
			this.fullScreenToggleButtonEnterUpIconTexture = _getTexture("full-screen-toggle-button-enter-up-icon0000");
			this.fullScreenToggleButtonEnterDownIconTexture = _getTexture("full-screen-toggle-button-enter-down-icon0000");
			this.fullScreenToggleButtonExitUpIconTexture = _getTexture("full-screen-toggle-button-exit-up-icon0000");
			this.fullScreenToggleButtonExitDownIconTexture = _getTexture("full-screen-toggle-button-exit-down-icon0000");
			this.muteToggleButtonMutedUpIconTexture = _getTexture("mute-toggle-button-muted-up-icon0000");
			this.muteToggleButtonMutedDownIconTexture = _getTexture("mute-toggle-button-muted-down-icon0000");
			this.muteToggleButtonLoudUpIconTexture = _getTexture("mute-toggle-button-loud-up-icon0000");
			this.muteToggleButtonLoudDownIconTexture = _getTexture("mute-toggle-button-loud-down-icon0000");
			this.volumeSliderMinimumTrackSkinTexture = _getTexture("volume-slider-minimum-track-skin0000");
			this.volumeSliderMaximumTrackSkinTexture = _getTexture("volume-slider-maximum-track-skin0000");
			this.seekSliderProgressSkinTexture = _getTexture("seek-slider-progress-skin0000");
		}
	...
	//-------------------------
		...
		{
			var skin:ImageSkin = new MyImageSkin(this.buttonUpSkinTexture);
	...
	//-------------------------
		...
		{
			var skin:ImageSkin = new MyImageSkin(this.buttonCallToActionUpSkinTexture);
		...
		{
			var defaultSkin:Quad = new MyQuad(this.controlSize, this.controlSize, 0xff00ff);
			defaultSkin.alpha = 0;
			button.defaultSkin = defaultSkin;

			var otherSkin:ImageSkin = new MyImageSkin(null);
		...
		{
			var skin:ImageSkin = new MyImageSkin(this.buttonDangerUpSkinTexture);
		...
		{
			var skin:ImageSkin = new MyImageSkin(this.buttonBackUpSkinTexture);
		...
		{
			var skin:ImageSkin = new MyImageSkin(this.buttonForwardUpSkinTexture);
	...
	//-------------------------
		...
		{
			var icon:ImageSkin = new MyImageSkin(this.checkUpIconTexture);
	...
	//-------------------------
		...
		{
			var overlaySkin:Quad = new MyQuad(10, 10, DRAWER_OVERLAY_COLOR);
			overlaySkin.alpha = DRAWER_OVERLAY_ALPHA;
			drawers.overlaySkin = overlaySkin;

			var topDrawerDivider:Quad = new MyQuad(this.borderSize, this.borderSize, DRAWER_OVERLAY_COLOR);
			drawers.topDrawerDivider = topDrawerDivider;

			var rightDrawerDivider:Quad = new MyQuad(this.borderSize, this.borderSize, DRAWER_OVERLAY_COLOR);
			drawers.rightDrawerDivider = rightDrawerDivider;

			var bottomDrawerDivider:Quad = new MyQuad(this.borderSize, this.borderSize, DRAWER_OVERLAY_COLOR);
			drawers.bottomDrawerDivider = bottomDrawerDivider;

			var leftDrawerDivider:Quad = new MyQuad(this.borderSize, this.borderSize, DRAWER_OVERLAY_COLOR);
	...
	//-------------------------
		...
		protected function setGroupedListStyles(list:GroupedList):void
		{
			...
			var backgroundSkin:Quad = new MyQuad(this.gridSize, this.gridSize, LIST_BACKGROUND_COLOR);
		...
		{
			renderer.backgroundSkin = new MyQuad(1, 1, GROUPED_LIST_HEADER_BACKGROUND_COLOR);
		...
		{
			renderer.backgroundSkin = new MyQuad(1, 1, GROUPED_LIST_FOOTER_BACKGROUND_COLOR);
		...
		{
			var skin:ImageSkin = new MyImageSkin(defaultSkinTexture);
		...
		{
			var defaultSkin:Quad = new MyQuad(1, 1, 0xff00ff);
			defaultSkin.alpha = 0;
	...
	//-------------------------
		...
		{
			var skin:ImageSkin = new MyImageSkin(this.itemRendererUpSkinTexture);
		...
		protected function setDrillDownItemRendererStyles(itemRenderer:DefaultListItemRenderer):void
		{
			...
			var accessorySkin:ImageSkin = new MyImageSkin(this.listDrillDownAccessoryTexture);
		...
		protected function setCheckItemRendererStyles(renderer:BaseDefaultItemRenderer):void
		{
			...
			var defaultIcon:Quad = new MyQuad(defaultSelectedIcon.width, defaultSelectedIcon.height, 0xff00ff);
			defaultIcon.alpha = 0;
	...
	//-------------------------
		...
		protected function setPickerListButtonStyles(button:Button):void
		{
			...
			var icon:ImageSkin = new MyImageSkin(this.pickerListButtonIconTexture);
	...
	//-------------------------
		...
		{
			var icon:ImageSkin = new MyImageSkin(this.radioUpIconTexture);
	...
	//-------------------------
		...
		{
			var skin:ImageSkin = new MyImageSkin(this.backgroundSkinTexture);
	...
	//-------------------------
		...
		{
			var skin:ImageSkin = new MyImageSkin(this.tabUpSkinTexture);
	...
	//-------------------------
		...
		protected function setTextAreaStyles(textArea:TextArea):void
		{
			...
			var skin:ImageSkin = new MyImageSkin(this.backgroundInsetSkinTexture);
	...
	//-------------------------
		...
		protected function setSearchTextInputStyles(input:TextInput):void
		{
			...
			var icon:ImageSkin = new MyImageSkin(this.searchIconTexture);
	...
	//-------------------------
		...
		{
			var icon:ImageSkin = new MyImageSkin(this.playPauseButtonPlayUpIconTexture);
		...
		{
			var icon:ImageSkin = new MyImageSkin(null);
			...
			var overlaySkin:Quad = new MyQuad(1, 1, VIDEO_OVERLAY_COLOR);
	...
	//-------------------------
		...
		{
			var icon:ImageSkin = new MyImageSkin(this.fullScreenToggleButtonEnterUpIconTexture);
	...
	//-------------------------
		...
		{
			var icon:ImageSkin = new MyImageSkin(this.muteToggleButtonLoudUpIconTexture);
	...
	//-------------------------
		...
		protected function setSeekSliderThumbStyles(thumb:Button):void
		{
			...
			thumb.defaultSkin = new MyQuad(thumbSize, thumbSize);
			thumb.hasLabelTextRenderer = false;
	...
	//-------------------------
		...
		{
			var thumbSize:Number = 6;
			var defaultSkin:Quad = new MyQuad(thumbSize, thumbSize);
			defaultSkin.width = 0;
...
import harayoki.feathers.themes.BaseCustomMetalWorksMobileTheme;
...
internal class MyImageSkin extends ImageSkin {
	public function MyImageSkin(defaultTexture:starling.textures.Texture = null){
		super(defaultTexture);
		textureSmoothing = TextureSmoothing.NONE;
	}
}

internal class MyQuad extends Quad {
	public function MyQuad(w:int,h:int,c:uint=0xffffff) {
		super(w,h,c);
		texture = BaseCustomMetalWorksMobileTheme.dummyTexture;
		textureSmoothing = TextureSmoothing.NONE;
	}
}