package demos {
	...
	public class PosterizationFilterDemo extends DemoBase {
		...
		public function PosterizationFilterDemo(assetManager:harayoki.starling2.utils.AssetManager, starling:Starling = null) {
			 frontDisplay = true;
