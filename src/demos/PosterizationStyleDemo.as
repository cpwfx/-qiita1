package demos {
	...
	public class PosterizationStyleDemo extends DemoBase {
		...
		public function PosterizationStyleDemo(assetManager:harayoki.starling2.utils.AssetManager, starling:Starling = null) {
			 frontDisplay = true;
